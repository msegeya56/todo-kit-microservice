...
import (
	...
	http "github.com/msegeya56/todo #4 #3-kit-microsrvice/customer/pkg/http"
...
var fs = flag.NewFlagSet("customer", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		// recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "customer")
